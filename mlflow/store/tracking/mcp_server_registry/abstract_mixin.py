...
class MCPServerRegistryMixin:
    ...
    def get_latest_mcp_server_version(self, name: str) -> MCPServerVersion:
        ...
        Resolves to the highest semantic version among ACTIVE versions for the
        named server. If no ACTIVE version exists, implementations should raise
        ...
        Raises:
            MlflowException: If no ACTIVE version exists.
        """
        raise NotImplementedError(self.__class__.__name__)
